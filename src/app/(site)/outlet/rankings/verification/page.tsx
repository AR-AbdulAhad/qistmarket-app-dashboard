...
import { ShieldCheck, TrendingUp, TrendingDown, Minus, RefreshCw, Store, Filter } from "lucide-react";
                            ...
                            {filtered.map((officer, idx) => (
                                <div key={officer.id} className="flex items-center gap-6 p-6 hover:bg-gray-50 dark:hover:bg-meta-4/20 transition-colors">
                                    ...
                                    <div className="hidden md:flex items-center gap-8 flex-shrink-0">
                                        ...
                                        {officer.avg_verification_minutes != null && (
                                            <div className="text-center">
                                                <p className="text-[9px] font-black uppercase tracking-widest text-gray-400 mb-0.5">Avg Time</p>
                                                <p className="text-base font-black text-gray-800 dark:text-white">{officer.avg_verification_minutes}m</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
