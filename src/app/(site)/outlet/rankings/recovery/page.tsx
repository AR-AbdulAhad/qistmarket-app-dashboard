...
import { UserCircle, TrendingUp, TrendingDown, Minus, RefreshCw, Store, Filter } from "lucide-react";
            ...
            <div className="mx-auto max-w-7xl space-y-8">
                ...
                {loading ? (
                    ...
                    <div className="py-24 text-center">
                        ...
                        <p className="text-xl font-bold text-gray-500">No recovery officers ranked yet</p>
                    ...
                    <div className="rounded-[2rem] border border-stroke dark:border-strokedark bg-white dark:bg-boxdark shadow-sm overflow-hidden">
                        <div className="p-6 border-b border-stroke dark:border-strokedark bg-purple-50/50 dark:bg-purple-500/5 flex items-center justify-between">
                            <p className="text-sm font-black uppercase tracking-widest text-purple-600 flex items-center gap-2">
                                <UserCircle size={16} /> {filtered.length} Officers Ranked
                            </p>
                            {selectedOutlet !== "all" && (
                        ...
                        <div className="divide-y divide-stroke dark:divide-strokedark">
                            {filtered.map((officer) => (
                                <div key={officer.id} className="flex items-center gap-6 p-6 hover:bg-gray-50 dark:hover:bg-meta-4/20 transition-colors">
                                    ...
                                    {/* Avatar */}
                                    <div className="w-12 h-12 bg-purple-500/10 rounded-2xl flex items-center justify-center text-purple-600 text-xl font-black flex-shrink-0">
                                        ...
                                        <div className="flex items-center gap-2 mb-1">
                                            <p className="text-base font-black text-gray-800 dark:text-white truncate">
                                                ...
                                                {currentUser?.id === officer.officer_id
                                                    ? <span className="ml-2 text-sm text-purple-500">(You)</span>
                                    ...
                                    <div className="hidden md:flex items-center gap-8 flex-shrink-0">
                                        <div className="text-center">
                                            ...
                                            <p className="text-xl font-black text-purple-600">{officer.score}</p>
                                        </div>
                                        {officer.visit_count != null && (
                                            <div className="text-center">
                                                <p className="text-[9px] font-black uppercase tracking-widest text-gray-400 mb-0.5">Visits</p>
                                                <p className="text-base font-black text-gray-800 dark:text-white">{officer.visit_count}</p>
                                            </div>
                                        )}
                                        {officer.amount_collected != null && (
                                            <div className="text-center">
                                                <p className="text-[9px] font-black uppercase tracking-widest text-green-500 mb-0.5">Collected</p>
                                                <p className="text-base font-black text-green-600">PKR {officer.amount_collected?.toLocaleString()}</p>
                                            </div>
                                        )}
                                        {officer.recovery_rate != null && (
                                            <div className="text-center">
                                                <p className="text-[9px] font-black uppercase tracking-widest text-purple-500 mb-0.5">Rate</p>
                                                <p className="text-base font-black text-purple-600">{officer.recovery_rate?.toFixed(1)}%</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
