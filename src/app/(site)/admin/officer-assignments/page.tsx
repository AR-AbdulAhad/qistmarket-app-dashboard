...
const zones = ["Central", "East", "West", "South", "Malir", "Korangi"];

const karachiAreas = [
    "Abbas Town", "Abdullah Haroon Road", "Abid Town", "Abu Zar Ghaffari", "Abul Hassan Isphani Road",
    "Abul Isphani Road", "Agra Taj Colony", "Airport", "Akhtar Colony", "Alamgir Society",
    "Ameeruddin Memon Colony", "Ancholi", "Askari 1", "Askari 2", "Askari 3", "Askari 4",
    "Bahria Town Karachi", "Baldia Town", "Battery Road", "Buffer Zone", "Cantonment",
    "Clifton", "DHA", "Federal B Area", "Gadap Town", "Gulistan-e-Johar", "Gulshan-e-Iqbal",
    "Jamshed Road", "Jinnah Colony", "Korangi", "Liaquatabad", "Malir", "Nazimabad",
    "North Karachi", "North Nazimabad", "Orangi Town", "PECHS", "Saddar", "Shah Faisal Colony",
    "Sharafi Goth", "Saudabad", "Surjani Town"
];
...
const OfficerAssignmentsPage = () => {
    ...
    const fetchOfficers = async () => {
        try {
            ...
            const resp = await fetch(`${BACKEND_URL}/api/assignments/officers`, {
            ...
            if (data.success) {
                ...
                toast.error(data.error?.message || "Failed to fetch officers");
            }
        } catch (err) {
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                            {loading ? (
                                <tr><td colSpan={4} className="px-6 py-10 text-center">Loading officers...</td></tr>
