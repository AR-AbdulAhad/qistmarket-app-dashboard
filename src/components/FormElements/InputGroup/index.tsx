    ...
    <div className={className}>
      ...
      >
        <input
          ...
          className={cn(
            "w-full rounded-lg border-[1.5px] border-stroke bg-transparent outline-none transition focus:border-[#ff3d3d] disabled:cursor-default disabled:bg-gray-2 data-[active=true]:border-[#ff3d3d]",
            type === "file"
