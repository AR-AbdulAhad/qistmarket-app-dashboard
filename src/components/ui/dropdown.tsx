...
export function DropdownContent({
  ...
  return (
    <div
      ...
      className={cn(
        "fixed !z-[9999] mt-2 min-w-[8rem] origin-top-right rounded-lg shadow-xl pointer-events-auto bg-white dark:bg-gray-900 border border-stroke dark:border-dark-3",
        align === "end" && "right-0",
        align === "start" && "left-0",
